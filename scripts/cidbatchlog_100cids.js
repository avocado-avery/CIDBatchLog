/**
 * scripts/cidbatchlog_100cids.js
 *
 * Run:
 *   truffle migrate --reset --network development
 *   truffle exec scripts/cidbatchlog_100cids.js --network development
 */
...
const LOG_PATH = path.join(__dirname, "..", "cidbatchlog_100cids.log");
